...
class AccelerateFSDPArgParser:
    def __init__(self, description="PyTorch FSDP Example"):
        ...
        self.parser.add_argument(
            ...
            + f"distributed-training/accelerate_dist/fsdp/profiler/{os.environ['SLURM_JOB_ID']}",
        ...
        self.parser.add_argument(
            ...
            type=str,
            default="/home/bsc/bsc206334/Workspace/"
            + f"distributed-training/accelerate_dist/fsdp/checkpoints/{os.environ['SLURM_JOB_ID']}",
            help="Directory to save profiling logs",
        )
        self.parser.add_argument(
            "--enable-checkpoints",
            action="store_true",
            default=False,
            help="Enable checkpointing at the env of epochs when validation loss improves",
        )
        self.parser.add_argument(
        ...
        self.parser.add_argument(
            "--precompile-dynamo-cudagraphs",
            action="store_true",
            default=False,
            help="Enable precompilation of dynamo cudagraphs for performance optimization",
        )
